...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=NeZcab Demo Installer\n"
      else:
        line="OutputBaseFilename=NeZcab Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the NeZcab Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the NeZcab installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=NeZcab Demo installer\n"
     else:
       line="SetupWindowTitle=NeZcab installer\n"
